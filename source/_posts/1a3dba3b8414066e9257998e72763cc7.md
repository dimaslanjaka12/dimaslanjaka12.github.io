...
incoming terms:
  ...
  - git add submodule from subfolder
	...
	- git move other repository as submodule<hr/> <a href="https://www.webmanajemen.com/2022/03/git-add-existing-local-repository-folder-to-submodule.html" rel="follow" class="button" id="read-more">Read More</a>