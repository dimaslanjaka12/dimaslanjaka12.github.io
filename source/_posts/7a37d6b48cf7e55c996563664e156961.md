...
<hr/> [THIS SITE IS MIRROR](https://www.webmanajemen.com) Skip to Full Contents <a href="https://www.webmanajemen.com/2017/11/pure-css3-3d-icons-using-font-awesome.html" rel="follow" class="button" id="read-more">Read More</a> <hr/> Pure CSS3 3D Icons Using Font Awesome 4.7.0 - img width=350 height=300 alt=CSS3 3D Transformation layout=responsive HTML
