...
## Browser support
This function has been tested and works well on the latest version of **Google Chrome** browser. For other browsers, please try.<hr/> <a href="https://www.webmanajemen.com/2022/03/how-to-overcome-automatic-scroll-up-in-blogger-xml-editor.html" rel="follow" class="button" id="read-more">Read More</a>