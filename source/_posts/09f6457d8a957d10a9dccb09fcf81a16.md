...
<hr/> Skip to Full Contents <a href="https://www.webmanajemen.com/2022/03/vscode-migrate-ts-project-to-esm.html" rel="follow" class="button" id="read-more">Read More</a> <hr/> VSCode Migrate Typescript CommonJS to ESM - VSCode Migrate Typescript CommonJS to ESM ## How to migrate typescript commonjs to esm with vscode
...
### Method 2
-   Search: `^(import [^';]* from '(\./|(\.\./)+)[^';.]*)';`
-   Replace: `$1.js';` <hr/> Skip to Full Contents <a href="https://www.webmanajemen.com/2022/03/vscode-migrate-ts-project-to-esm.html" rel="follow" class="button" id="read-more">Read More</a> <hr/>