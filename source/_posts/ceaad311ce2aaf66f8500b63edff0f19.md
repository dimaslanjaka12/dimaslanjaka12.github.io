...
Usage: <code>code block</code>
  <h3>Welcome to the real-time HTML editor!</h3>     <p>Type HTML in the textarea above, and it will magically appear in the frame below.</p>  
Pre (Single Pretext)
...
Couldn't find the language you were looking for? Request it! <hr/> [THIS SITE IS MIRROR](https://www.webmanajemen.com/2020/01/simple-prismjs.html) || <a href="https://www.webmanajemen.com/2020/01/simple-prismjs.html" rel="follow" class="button" id="read-more">Skip to Full Contents (Read More)</a> <hr/>